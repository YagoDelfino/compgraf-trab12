 ...
 *
 * Summary.
 * <p>This example combines a skybox with a fully reflective teapot.</p>
 ...
 *
 * @since 01/01/2019
 * @see https://lcg.ufrj.br/WebGL/labs/WebGL/extras/skybox-and-env-map.html?m=0
 * @see <a href="/WebGL/labs/WebGL/extras/skybox-and-env-map.js">source</a>
 * @see <a href="/WebGL/lib/simple-rotator.js">simple-rotator</a>
 * @see <a href="/WebGL/lib/basic-objects-IFS.js">basic-objects-IFS.js</a>
 * @see http://math.hws.edu/eck/cs424/notes2013/19_GLSL.html
 ...
 * @see <img src="../skybox.png" width="512">
 */
 ...
 /**
  * For drawing the reflective teapot.
  * @type {GLint}
  */
 var aCoords;
 var aNormal;
 ...
 /**
  * Additional rotations applied as modeling transform to the teapot.
  */
 var rotX = 0,
   rotY = 0;
   ...
   try {
     ...
     switch (m) {
       ...
       case 2:
         ...
         break;
       default:
         teapot = createModel(uvTorus(5, 10, 30, 30));
         break;
     }
